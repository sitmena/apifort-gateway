...
import me.sitech.apifort.domain.response.ClientEndpointResponse;
...
public class CreateEndpointProcessor implements Processor {
    ...
    public void publishToRedisCache(String apiKey, ClientEndpointPanacheEntity entity) throws JsonProcessingException {
        ...
        redisClient.set(Arrays.asList(new DigestUtils("SHA-1").digestAsHex(entity.getMethodType()+entity.getEndpointRegex())
